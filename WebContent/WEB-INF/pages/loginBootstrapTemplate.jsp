...
<body id="page-top">
	...
	<!-- Login Section -->
	<section class="container" id="login" ng-app="validation" ng-controller="RegistrationController as registration">
    	<div class="row">
	    	<sec:authorize
				access="hasAnyRole('ROLE_ADMIN', 'ROLE_USER')?false:true">
						...
						<div class="panel-body">
							<div class="row">
								<div class="col-lg-12">
									...
									<form id="register-form" name="registerform" action="signUp" method="post" role="form" style="display: none;" novalidate 
										...
										<div class="form-group" 
											...
											<input type="text" name="firstName" id="firstname" tabindex="1" class="form-control" placeholder="First Name" 
												ng-model="firstName" ng-pattern="/^[a-zA-Z]+$/" required>
											<div class="help-block"
												ng-messages="registerform.firstName.$error"
												ng-messages-multiple
												ng-if="registerform.firstName.$dirty">
													<p ng-message="required" style="color: #f05f40;">Your first name is required.</p>
										...
										<div class="form-group"
											...
											<input type="text" name="lastName" id="lastname" tabindex="2" class="form-control" placeholder="Last Name" 
												ng-model="lastName" ng-pattern="/^[a-zA-Z]+$/" required>
											<div class="help-block"
												ng-messages="registerform.lastName.$error"
												ng-messages-multiple
												ng-if="registerform.lastName.$dirty">
													<p ng-message="required" style="color: #f05f40;">Your last name is required.</p>
													<p ng-message="pattern" style="color: #f05f40;">This field only accept alphabet.</p>
											</div>
										</div>
										...
										<div class="form-group" 
											...
											<input type="text" name="username" id="username" tabindex="3" class="form-control" placeholder="Username" 
												ng-model="username" ng-minlength="3" ng-maxlength="10" username-valid required>
											<div class="help-block"
    ...
    <script src="js/angularValidation.js"></script>
